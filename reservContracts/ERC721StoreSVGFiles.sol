...
// Как полностью хранить метаданные NFT и изображение SVG в сети (ERC721/ERC1155)
// https://www.youtube.com/watch?v=QVWs9e4RFSA пример отсюда 
// https://gist.github.com/Chmarusso/045ee79fa9a1fae55928a613044c9067 код 
